    ...
    try:
        for entry in datos.get("entry") or []:
            for evento in entry.get("messaging") or []:
                ...
                # Fase 1: Messenger queda manual hasta validar recepción/envío.
                crm_poner_manual(contacto)
                ...
                # Guardamos el texto en memoria para que la futura fase de IA
                # ya tenga continuidad de conversación.
        ...
        {% if seleccionado %}
            <div class="chat-head">
                ...
                <div class="head-actions">
                    ...
                    {% else %}
                        <span class="status manual">MESSENGER · MANUAL</span>
                    {% endif %}
                </div>
            </div>
            ...
            <div class="notice" style="background:#eff6ff;border-color:#bfdbfe;color:#1d4ed8;">
                🔵 Messenger conectado al CRM en modo manual. Primero validaremos recepción y respuesta de texto; después activaremos IA y envíos rápidos.
            </div>
            {% endif %}
...
def crm_toggle(numero):
    ...
    if crm_es_facebook(numero):
        # En Fase 1 Messenger permanece manual hasta validar el canal.
